...
<body>
    <div class="container">
        ...
        <div class="top-buttons">
            ...
            <a href="les_inroosteren.php" class="nav-btn" style="background:#1b2940;color:white;text-decoration:none;">+
                Nieuwe les</a>
        </div>
                ...
                <?php foreach ($lessen as $les):
                    ...
                    <div class="les-kaart<?= $kaartClass ?>">
                        ...
                        <div class="les-info">
                            ...
                            <p>🎓 Instructeur:
                                <strong><?= htmlspecialchars($les['iVoornaam'] . ' ' . $les['iAchternaam']) ?></strong></p>
                            <?php if (!empty($les['iTelefoon'])): ?>
                                <p>📞 <?= htmlspecialchars($les['iTelefoon']) ?></p><?php endif; ?>
                        </div>
